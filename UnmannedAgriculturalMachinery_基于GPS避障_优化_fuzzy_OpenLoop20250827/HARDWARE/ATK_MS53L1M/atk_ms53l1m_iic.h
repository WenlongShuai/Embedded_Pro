...
#define DIR_MID					2
#define DIR_RIGHT				3
#define DIR_LEFTSIDE		4
#define DIR_RIGHTSIDE		5

#define ATK_MS53L1M_LEFT_ON 			1
#define ATK_MS53L1M_MID_ON 				1
#define ATK_MS53L1M_RIGHT_ON 			1
#define ATK_MS53L1M_LEFTSIDE_ON 	1
#define ATK_MS53L1M_RIGHTSIDE_ON 	1
...
/* 引脚定义 */
#define ATK_MS53L1M_IIC_SCL_GPIO_PORT_MID            GPIOF
#define ATK_MS53L1M_IIC_SCL_GPIO_PIN_MID             GPIO_Pin_4
#define ATK_MS53L1M_IIC_SCL_GPIO_CLK_ENABLE_MID()    do{ RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOF, ENABLE); }while(0)
#define ATK_MS53L1M_IIC_SDA_GPIO_PORT_MID            GPIOF
#define ATK_MS53L1M_IIC_SDA_GPIO_PIN_MID             GPIO_Pin_5
#define ATK_MS53L1M_IIC_SDA_GPIO_CLK_ENABLE_MID()    do{ RCC_APB2PeriphClockCmd(RCC_AHB1Periph_GPIOF, ENABLE); }while(0)
...
#define ATK_MS53L1M_IIC_SCL_GPIO_PIN_RIGHT             GPIO_Pin_6
...
#define ATK_MS53L1M_IIC_SDA_GPIO_PIN_RIGHT             GPIO_Pin_7
...
/*******左侧激光*******/																								
#if ATK_MS53L1M_LEFTSIDE_ON
/* 引脚定义 */
#define ATK_MS53L1M_IIC_SCL_GPIO_PORT_LEFTSIDE            GPIOF
#define ATK_MS53L1M_IIC_SCL_GPIO_PIN_LEFTSIDE             GPIO_Pin_8
#define ATK_MS53L1M_IIC_SCL_GPIO_CLK_ENABLE_LEFTSIDE()    do{ RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOF, ENABLE); }while(0)
#define ATK_MS53L1M_IIC_SDA_GPIO_PORT_LEFTSIDE            GPIOF
#define ATK_MS53L1M_IIC_SDA_GPIO_PIN_LEFTSIDE            	GPIO_Pin_9
#define ATK_MS53L1M_IIC_SDA_GPIO_CLK_ENABLE_LEFTSIDE()    do{ RCC_APB2PeriphClockCmd(RCC_AHB1Periph_GPIOF, ENABLE); }while(0)

/* IO操作 */
#define ATK_MS53L1M_IIC_SCL_LEFTSIDE(x)                   do{ x ?                                                                                             \
                                                    GPIO_SetBits(ATK_MS53L1M_IIC_SCL_GPIO_PORT_LEFTSIDE, ATK_MS53L1M_IIC_SCL_GPIO_PIN_LEFTSIDE) :    \
                                                    GPIO_ResetBits(ATK_MS53L1M_IIC_SCL_GPIO_PORT_LEFTSIDE, ATK_MS53L1M_IIC_SCL_GPIO_PIN_LEFTSIDE);   \
                                                }while(0)

#define ATK_MS53L1M_IIC_SDA_LEFTSIDE(x)                   do{ x ?                                                                                             \
                                                    GPIO_SetBits(ATK_MS53L1M_IIC_SDA_GPIO_PORT_LEFTSIDE, ATK_MS53L1M_IIC_SDA_GPIO_PIN_LEFTSIDE) :    \
                                                    GPIO_ResetBits(ATK_MS53L1M_IIC_SDA_GPIO_PORT_LEFTSIDE, ATK_MS53L1M_IIC_SDA_GPIO_PIN_LEFTSIDE);   \
                                                }while(0)

#define ATK_MS53L1M_IIC_READ_SDA_LEFTSIDE()               GPIO_ReadInputDataBit(ATK_MS53L1M_IIC_SDA_GPIO_PORT_LEFTSIDE, ATK_MS53L1M_IIC_SDA_GPIO_PIN_LEFTSIDE)

#endif

/*******右侧激光*******/																								
#if ATK_MS53L1M_RIGHTSIDE_ON
/* 引脚定义 */
#define ATK_MS53L1M_IIC_SCL_GPIO_PORT_RIGHTSIDE           	GPIOF
#define ATK_MS53L1M_IIC_SCL_GPIO_PIN_RIGHTSIDE            	GPIO_Pin_10
#define ATK_MS53L1M_IIC_SCL_GPIO_CLK_ENABLE_RIGHTSIDE()    	do{ RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOF, ENABLE); }while(0)
#define ATK_MS53L1M_IIC_SDA_GPIO_PORT_RIGHTSIDE           	GPIOF
#define ATK_MS53L1M_IIC_SDA_GPIO_PIN_RIGHTSIDE             	GPIO_Pin_11
#define ATK_MS53L1M_IIC_SDA_GPIO_CLK_ENABLE_RIGHTSIDE()    	do{ RCC_APB2PeriphClockCmd(RCC_AHB1Periph_GPIOF, ENABLE); }while(0)

/* IO操作 */
#define ATK_MS53L1M_IIC_SCL_RIGHTSIDE(x)                   do{ x ?                                                                                             \
                                                    GPIO_SetBits(ATK_MS53L1M_IIC_SCL_GPIO_PORT_RIGHTSIDE, ATK_MS53L1M_IIC_SCL_GPIO_PIN_RIGHTSIDE) :    \
                                                    GPIO_ResetBits(ATK_MS53L1M_IIC_SCL_GPIO_PORT_RIGHTSIDE, ATK_MS53L1M_IIC_SCL_GPIO_PIN_RIGHTSIDE);   \
                                                }while(0)

#define ATK_MS53L1M_IIC_SDA_RIGHTSIDE(x)                   do{ x ?                                                                                             \
                                                    GPIO_SetBits(ATK_MS53L1M_IIC_SDA_GPIO_PORT_RIGHTSIDE, ATK_MS53L1M_IIC_SDA_GPIO_PIN_RIGHTSIDE) :    \
                                                    GPIO_ResetBits(ATK_MS53L1M_IIC_SDA_GPIO_PORT_RIGHTSIDE, ATK_MS53L1M_IIC_SDA_GPIO_PIN_RIGHTSIDE);   \
                                                }while(0)

#define ATK_MS53L1M_IIC_READ_SDA_RIGHTSIDE()               GPIO_ReadInputDataBit(ATK_MS53L1M_IIC_SDA_GPIO_PORT_RIGHTSIDE, ATK_MS53L1M_IIC_SDA_GPIO_PIN_RIGHTSIDE)
