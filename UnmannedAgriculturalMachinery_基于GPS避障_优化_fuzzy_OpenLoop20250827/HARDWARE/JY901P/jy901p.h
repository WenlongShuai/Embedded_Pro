...
*/
//typedef int32_t (*WitI2cWrite)(uint8_t ucAddr, uint8_t ucReg, uint32_t uiLen, uint8_t *p_ucVal);
...
*/
//typedef int32_t (*WitI2cRead)(uint8_t ucAddr, uint8_t ucReg, uint32_t uiLen, uint8_t *p_ucVal);
