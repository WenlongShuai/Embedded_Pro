...
#define ATK_MS53L1M_UART_TX_GPIO_PIN            GPIO_PIN_10
#define ATK_MS53L1M_UART_TX_GPIO_AF             GPIO_AF8_UART4
#define ATK_MS53L1M_UART_TX_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0) /* PC口时钟使能 */

#define ATK_MS53L1M_UART_RX_GPIO_PORT           GPIOC
#define ATK_MS53L1M_UART_RX_GPIO_PIN            GPIO_PIN_11
#define ATK_MS53L1M_UART_RX_GPIO_AF             GPIO_AF8_UART4
#define ATK_MS53L1M_UART_RX_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0) /* PC口时钟使能 */

#define ATK_MS53L1M_UART_INTERFACE              UART4
#define ATK_MS53L1M_UART_IRQn                   UART4_IRQn
#define ATK_MS53L1M_UART_IRQHandler             UART4_IRQHandler
#define ATK_MS53L1M_UART_CLK_ENABLE()           do{ __HAL_RCC_UART4_CLK_ENABLE(); }while(0) /* UART4 时钟使能 */
