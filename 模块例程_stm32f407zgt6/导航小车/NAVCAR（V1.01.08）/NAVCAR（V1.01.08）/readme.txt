...
注意事项:
	...
	5,务必短接探索者STM32F4开发板P10的PB11(RX)和GBC_TX以及PB10(TX)和GBC_RX
	6,开发板的串口1（USB_232转出来的串口）的波特率是115200。
	7,GPS连接的天线必须放置于室外，否则有可能收不到GPS信号。
	8,如有其他问题，请参考<ATK-S1216F8-BD模块问题汇总.pdf>(暂时没有这个文档)。
	9,本例程详细说明，见光盘：9，增值资料\1，ALIENTEK 产品资料\16，ATK-S1216F8-BD模块\ATK-S1216F8-BD模块使用说明_AN1605C.pdf
