...
{
    uint8_t res = 0;
	res = simiic_read_reg_IST(IST8310_IIC_ADDRESS, reg, SIMIIC_IST);
...
{
	simiic_write_reg_IST(IST8310_IIC_ADDRESS, reg, data);
...
{
	simiic_read_regs_IST(IST8310_IIC_ADDRESS, reg, buf, len, SIMIIC_IST);
...
{
	simiic_write_regs_IST(IST8310_IIC_ADDRESS, reg, data, len);
