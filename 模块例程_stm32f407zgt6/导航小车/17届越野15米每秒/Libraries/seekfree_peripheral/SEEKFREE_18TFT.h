...
* 					------------------------------------
* 					模块管脚			单片机管脚
* 					SCL					查看 TFT_SCL		宏定义的引脚	硬件SPI引脚不可随意切换
* 					SDA					查看 TFT_SDA		宏定义的引脚	硬件SPI引脚不可随意切换
* 					RES					查看 TFT_REST_PIN	宏定义的引脚
* 					DC					查看 TFT_DC_PIN		宏定义的引脚
* 					CS					查看 TFT_CS_PIN		宏定义的引脚	硬件SPI引脚不可随意切换
* 					BL					查看 TFT_BL_PIN		宏定义的引脚
* 					电源引脚
* 					VCC					3.3V电源
* 					GND					电源地
* 					最大分辨率128*160
...
#define TFT_REST_PIN	D5//D13															// 液晶复位引脚定义 由于实际通讯未使用D15因此 这里复用为GPIO
#define TFT_DC_PIN		D13//D5															// 液晶命令位引脚定义
#define TFT_CS_PIN		D7															// 定义SPI_CS引脚
#define TFT_BL_PIN		D15															// 液晶背光引脚定义
